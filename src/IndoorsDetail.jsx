...
const photos = [
  ...gridPhotos,
  '/assets/es-indoors-4.jpg',
  '/assets/es-indoors-5.jpg',
  '/assets/es-indoors-6.jpg',
]
...
export default function IndoorsDetail() {
    ...
    <div className="od-page">
      ...
      <div className="od-photo-grid">
        <div className="od-photo-main" onClick={() => openLightbox(0)}>
          <img src={gridPhotos[0]} alt="The Indoors" />
      ...
      <div className="od-stats-bar">
        <div className="od-stats-pills">
          {['Charming', 'Spacious', 'Kitchen', 'Common Areas'].map(p => (
      ...
      <div className="od-desc-box">
        <div className="od-desc-left">
          <h2 className="od-desc-headline">Set within a historic estate rooted in over a century of community life, our indoor gathering spaces are designed for meaningful moments.</h2>
          <p className="od-desc-body">From intimate gatherings to meaningful milestones, the indoor spaces at Nava Gardens provide a flexible setting designed to support your event. Warm, welcoming rooms offer space for conversation, celebration, and creativity throughout every season. Reserve your date and begin shaping an experience grounded in care and intention.</p>
        </div>
