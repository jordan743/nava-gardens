...
const gridPhotos = [
  '/assets/es-wedding-1.jpg',
  '/assets/es-wedding-2.jpg',
...
export default function WeddingsDetail() {
  ...
  return (
    <div className="od-page">
      ...
      {/* Hero */}
      <section className="od-hero" style={{ background: '#BAE8E5' }}>
        <PageNav onMenuOpen={() => setMenuOpen(true)} />
        <div className="od-hero-body">
          <div className="od-eyebrow-pill" style={{ borderColor: '#272727', color: '#272727' }}>EVENT SPACES</div>
          <h1 className="od-hero-headline" style={{ color: '#272727' }}>Weddings</h1>
        </div>
      </section>
      ...
      <div className="od-photo-grid">
        <div className="od-photo-main" onClick={() => openLightbox(0)}>
          <img src={gridPhotos[0]} alt="Weddings at Nava Gardens" />
      ...
      <div className="od-stats-bar">
        <div className="od-stats-pills">
          {['4 Baths', '7 Bedrooms', 'Kitchen', 'Common Areas'].map(p => (
      ...
      <div className="od-desc-box">
        <div className="od-desc-left">
          <h2 className="od-desc-headline">Nava Gardens offers a wedding setting shaped by history, landscape, and a spirit of gathering.</h2>
          <p className="od-desc-body">Celebrate your wedding in a place designed for connection and meaningful moments. The manor and surrounding grounds provide flexible spaces for ceremonies, receptions, and time with the people who matter most. Whether indoors or outdoors, the setting supports a day that feels personal, relaxed, and rooted in place. Reserve your date and begin planning a celebration that reflects your story.</p>
        </div>
      ...
      {lightboxOpen && (
        <div className="od-lightbox" onClick={closeLightbox}>
          ...
          <img className="od-lightbox-img" src={photos[lightboxIndex]} alt="" onClick={e => e.stopPropagation()} />
          ...
          <div className="od-lightbox-dots" onClick={e => e.stopPropagation()}>
            {photos.map((_, i) => (
              <button key={i} className={`od-lightbox-dot${lightboxIndex === i ? ' od-lightbox-dot--active' : ''}`} onClick={() => setLightboxIndex(i)} />
            ))}
          </div>
        </div>
      )}
